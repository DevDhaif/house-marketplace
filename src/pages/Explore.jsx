  ...
  return (
    ...
    <Hero />
      ...
      <main className='my-4'>
        ...
        <div className='my-4 flex gap-x-4 justify-between w-full'>
          <motion.div
            className="gap-y-4 w-full text-center "
            initial={{ opacity: 0, x: 900, y: 300 }}
            animate={{ opacity: 1, x: 0, y: 0 }}
            exit={{ opacity: 0 }}
            transition={{ duration: 1 }}>
            <Link to='/category/rent' className="gap-y-2">
          ...
          <motion.div
            className="gap-y-2 w-full  text-center"
            initial={{ opacity: 0, x: -900, y: 300 }}
            animate={{ opacity: 1, x: 0, y: 0 }}
            exit={{ opacity: 0 }}
            transition={{ duration: 1 }}>
            <Link to='/category/sale' className="gap-y-2">
